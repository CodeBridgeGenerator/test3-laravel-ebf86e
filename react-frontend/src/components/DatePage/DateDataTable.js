...
const DateDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate1 = (rowData, { rowIndex }) => <Calendar className="w-20rem" dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.calendar)} showTime ></Calendar>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10} rowClassName="cursor-pointer">
            ...
            <Column field="calendar" header="Calendar" body={calendarTemplate1} sortable style={{ minWidth: "8rem" }} />
