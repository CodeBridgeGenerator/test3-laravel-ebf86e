    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div>
                ...
                <Dropdown value={_entity?.profile} optionLabel="name" optionValue="value" options={profileOptions} onChange={(e) => setValByKey("profile", e.value)} />
            </div>
            <div>
                <p className="m-0">ProfileEmail:</p>
                <Dropdown value={_entity?.profileEmail} optionLabel="name" optionValue="value" options={profileEmailOptions} onChange={(e) => setValByKey("profileEmail", e.value)} />
            </div>
